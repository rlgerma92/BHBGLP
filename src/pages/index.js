    ...
    <div className="info">
      <div className={"row"}>
        <div className={"col-4"}>
          ...
          <h4>Oil Tinctures</h4>
          <p>
            Oil Tinctures are a popular choice among users because they are easy
            to use. For best results, hold a few drops under your tongue for
            10-20 seconds before swallowing.
          </p>
        </div>
        <div className={"col-4"}>
          ...
          <p>
            ...
            products. Topicals are a wonderful addition to any skincare routine.
